...
public class SoldatDuComteDeLor extends FactoryCarte {


	public SoldatDuComteDeLor(Joueur joueur, Joueur jAdversaire) {
		this.joueur = joueur;
	...
	public String toString(){
		return "Soldat du comte-de-l or -- "+getAttaque()+" d'attaque -- "+getVie()+" de vie -- " +getMana()+" nombre de mana --";
	}
}
