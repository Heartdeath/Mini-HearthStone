...
public class MaitriseDuBlocage extends FactoryCarte  {
	...
	public MaitriseDuBlocage(Joueur joueur, Joueur jAdversaire) {
		this.joueur = joueur;
	...
	public String toString(){
		return "Maitrise du blocage | " +getMana()+"nombre de mana | "+" Sort |" ;
	}
}
