...
public class ExplosionDesArcanes extends FactoryCarte {
	...
	public ExplosionDesArcanes(Joueur j, Joueur jAdv) {
		this.joueur = j;
	...
	public String toString(){
		return "Explosion des arcanes | " +getNbMana()+"nombre de mana | "+" Sort |" ;
	}
}
